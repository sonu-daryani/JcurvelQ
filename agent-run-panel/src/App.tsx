    ...
    <div className="agent-shell">
      <header className="agent-header-glass sticky top-0 z-10">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          <h1 className="text-base font-semibold tracking-tight text-zinc-900 dark:text-white">Agent Run Panel</h1>
          <div className="flex flex-wrap items-center gap-2">
            <div className="flex rounded-xl border border-zinc-200/80 bg-white/60 p-0.5 shadow-sm dark:border-zinc-700/80 dark:bg-zinc-900/60">
