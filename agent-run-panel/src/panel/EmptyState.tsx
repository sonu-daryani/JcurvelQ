export function EmptyState() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-dashed border-violet-300/60 bg-white/80 px-6 py-12 text-center shadow-sm dark:border-violet-800/50 dark:bg-zinc-900/60">
      ...
      <div className="relative mx-auto max-w-md text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
        <p className="font-semibold text-zinc-900 dark:text-zinc-100">No run loaded</p>
        <p className="mt-2">
